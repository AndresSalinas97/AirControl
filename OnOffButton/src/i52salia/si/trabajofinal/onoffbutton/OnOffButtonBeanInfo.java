...
/**
 * BeanInfo for the OnOffButton.
 * 
 * @author Andrés Salinas Lima {@literal <i52salia@uco.es>}
 */
public class OnOffButtonBeanInfo extends SimpleBeanInfo {
    
    /**
     * Constructor for the OnOffButtonBeanInfo class.
     */
    public OnOffButtonBeanInfo() {
        iconNameC32 = "/i52salia/si/trabajofinal/onoffbutton/resources/images/iconColor32.png";
        iconNameC16 = "/i52salia/si/trabajofinal/onoffbutton/resources/images/iconColor16.png";
    }

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_turnedOn = 90;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_turnedOn] = new PropertyDescriptor ( "turnedOn", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isTurnedOn", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( i52salia.si.trabajofinal.onoffbutton.OnOffButton.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_turn139 = 139;
    private static final int METHOD_turnOff140 = 140;
    private static final int METHOD_turnOn141 = 141;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_turn139] = new MethodDescriptor(i52salia.si.trabajofinal.onoffbutton.OnOffButton.class.getMethod("turn", new Class[] {})); // NOI18N
            methods[METHOD_turn139].setDisplayName ( "" );
            methods[METHOD_turnOff140] = new MethodDescriptor(i52salia.si.trabajofinal.onoffbutton.OnOffButton.class.getMethod("turnOff", new Class[] {})); // NOI18N
            methods[METHOD_turnOff140].setDisplayName ( "" );
            methods[METHOD_turnOn141] = new MethodDescriptor(i52salia.si.trabajofinal.onoffbutton.OnOffButton.class.getMethod("turnOn", new Class[] {})); // NOI18N
            methods[METHOD_turnOn141].setDisplayName ( "" );
